  ...
  <UModal 
    ...
    <div class="h-auto w-full p-5 flex flex-col gap-3">
      ...
      <section class="flex justify-between items-center">
        <h1 class="text-lg font-semibold">Motion</h1>
        <UIcon 
          name="i-lucide-x" 
          class="text-xl hover:opacity-50 cursor-pointer" 
          @click="closeModal" />
      </section>
      ...
      <section class="flex flex-col">
        <div class="flex justify-between items-center">
          ...
          <span class="text-xs text-custom-400">Date added: --</span>
        </div>
